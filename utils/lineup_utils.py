...
from utils.mlb_stats import stats
...
def get_lineup(season_years: list, team_lineup: list):
    ...
    """
    Take care of this in the inning

    # who is up to bat
    batter_index = team_lineup.index(str(input(f'Who is batting?\n')))

    # set the lineup order
    lineup1 = team_lineup[batter_index:]
    lineup2 = team_lineup[:batter_index]

    team_lineup = lineup1 + lineup2
    """
